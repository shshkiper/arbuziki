...
class BookData {
  static List<Book> get featuredBooks => [
    Book(
      ...
      description:
          'Антиутопический роман о тоталитарном обществе, где каждый шаг человека контролируется Большим Братом.',
      image: 'book1.jpg',
      genre: 'Антиутопия',
      rating: 4.5,
      pages: 328,
    ...
    Book(
      ...
      description:
          'Мистический роман о добре и зле, любви и предательстве, действие которого разворачивается в Москве 1930-х годов.',
      image: 'book2.jpg',
      genre: 'Мистика',
      rating: 4.8,
      pages: 512,
    ...
    Book(
      ...
      description:
          'Эпический роман о семье Буэндиа и городе Макондо, написанный в стиле магического реализма.',
      image: 'book3.jpg',
    ...
    Book(
      ...
      author: 'Лев Толстой',
      description:
          'Эпический роман о войне 1812 года и жизни русского общества начала XIX века.',
      image: 'book4.jpg',
    ...
    Book(
      ...
      description:
          'Психологический роман о студенте Раскольникове, который совершает убийство и переживает муки совести.',
      image: 'book5.jpg',
    ...
    Book(
      ...
      author: 'Лев Толстой',
      description:
          'Роман о трагической любви замужней женщины Анны Карениной к офицеру Вронскому.',
      image: 'book6.jpg',
      genre: 'Классическая литература',
      rating: 4.4,
      pages: 864,
  ...
  static List<Book> get newReleases => [
    Book(
      ...
      description:
          'Полное руководство по приготовлению идеального кофе в домашних условиях.',
      image: 'book7.jpg',
      genre: 'Кулинария',
      rating: 4.8,
      pages: 256,
    ...
    Book(
      ...
      description:
          'Классическое руководство по эффективному чтению и пониманию текстов.',
      image: 'book8.jpg',
      genre: 'Образование',
      rating: 4.6,
      pages: 320,
  ...
  static List<Book> get bestsellers => [
    Book(
      ...
      author: 'Айн Рэнд',
      description:
          'Философский роман о капитализме, индивидуализме и роли государства в экономике.',
      image: 'book9.jpg',
    ...
    Book(
      ...
      description:
          'Философская сказка о маленьком принце, который путешествует по разным планетам.',
      image: 'book10.jpg',
